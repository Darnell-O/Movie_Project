...
fun SignUpRoute(
    ...
    SignUpScreen(
        ...
        onGoogleSignInResult = viewModel::signInWithGoogle,
...
private fun SignUpScreen(
    ...
    Column(
        ...
        if (isLoading) {
            ...
            OutlinedButton(
                onClick = { /* Google sign-in handled by caller via activity result */ },
                modifier = Modifier.fillMaxWidth(),
                border = BorderStroke(1.dp, Iris),
                colors = ButtonDefaults.outlinedButtonColors(contentColor = Iris)
            ) {
                Row(
            ...
            TextButton(
                ...
                Text("Already have an account? Login", color = Iris)
            }
        }
    }
}
